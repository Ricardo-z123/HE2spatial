...
class PosEmbed(nn.Module):
    ...
    def __init__(self, dim):
        super().__init__()
        self.x_embed = nn.Embedding(64, dim)  # learnable x-axis lookup table, vocab=64 (coords must be <64); NOT fixed sin/cos
        self.y_embed = nn.Embedding(64, dim)  # learnable y-axis lookup table, vocab=64; weight[64, dim]
    ...
    def forward(self, coords):
        ...
        # each lookup -> [N, L, dim] (full dim, not split); ADD them, NOT concat
